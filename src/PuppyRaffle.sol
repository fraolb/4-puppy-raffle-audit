...
contract PuppyRaffle is ERC721, Ownable {
    ...
    /**
     *
     * @audit Gas Issue Duplicate should be checked while adding to the players[]
     * @audit User is not paying to entrance fee
     */
    ...
    /**
     *
     * @audit Blank spots can alter the raffle outcome
     */
    ...
    /**
     * @audit the winner index can be known since it is on chain
     * @audit the totalAmountCollected could be lower if there are players who ask refund. since gas fee comes from the contract
     * @audit rarity is not also random
     */
    ...
    /**
     * @audit the totalFees could be different from the balance if players get refunds. due to gas fee
     */
